...
interface PaymentModalProps {
  ...
  onClose: () => void;
  onPaymentComplete: (installmentId: number) => void;
}
...
const PaymentModal: React.FC<PaymentModalProps> = ({ 
  ...
  const handlePaymentConfirmed = () => {
    onPaymentComplete(installment.id);
      ...
      <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            <h3 className="font-medium text-blue-800 mb-2">Detalhes da Parcela</h3>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            ...
            <ol className="text-sm text-yellow-700 space-y-1 list-decimal list-inside">
              ...
              <li>Confirme o pagamento de {formatCurrency(installment.amount)}</li>
